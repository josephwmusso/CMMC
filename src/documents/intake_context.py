...
DEFAULTS: dict[str, Any] = {
    "org_name":             "[NOT PROVIDED — complete organization setup]",
    "org_location":         "[NOT PROVIDED]",
    "employee_count":       0,
    "cage_code":            "",
    "physical_locations":   1,
    "cui_types":            "",
    "cui_flow":             "",
    "identity_provider":    "[NOT PROVIDED — complete Module 0]",
    "email_platform":       "[NOT PROVIDED — complete Module 0]",
    "edr_tool":             "[NOT PROVIDED — complete Module 0]",
    "firewall":             "[NOT PROVIDED — complete Module 0]",
    "siem":                 "[NOT PROVIDED — complete Module 0]",
    "backup_tool":          "[NOT PROVIDED — complete Module 0]",
    "training_tool":        "[NOT PROVIDED — complete Module 0]",
    "msp_provider":         None,
